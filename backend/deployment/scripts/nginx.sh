...
FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS="leopard"
...
sudo cp "/home/ubuntu/$PROJECT_MAIN_DIR_NAME/deployment/nginx/nginx.conf" "/etc/nginx/sites-available/$FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS"
